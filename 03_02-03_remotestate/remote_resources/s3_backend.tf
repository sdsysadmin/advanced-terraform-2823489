...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "blue30-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "blue30-tfremotestate" {
  bucket = aws_s3_bucket.blue30-tfremotestate.id
